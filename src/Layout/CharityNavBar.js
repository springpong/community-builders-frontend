...
export default class CharityNavBar extends Component {
...
<div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="myNavbar">
        ...
        <ul className="nav navbar-nav navbar-right">   
            ...
            <li><a href="http://localhost:8080/CharityView" target="_self">
                 View Profile</a></li>
            <li><a href="http://localhost:8080/CharityEvent">Create Event</a></li>
        </ul>
    </div>
</div>
</nav>
